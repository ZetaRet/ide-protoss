...
var cfg = {
	...
	nskey = cfg.packageid + '.',
	cfgkeys = ['autoUpdateOnChange', 'breadcrumbs', 'console', 'textColor', 'fontSize', 'notifications', 'groupdigits', 'grammarId', 'findTokenCaseSensitivity', 'zetaret_omnipotency'],
	cfgobserve = {},
	disposables = null,
	bindings = {};
var defDescriptor = {
...
var gjs = atom.grammars.getGrammars().find(selectGrammar);
