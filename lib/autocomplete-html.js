...
var other = ['Element', 'Node', 'EventTarget',
	'BeforeUnloadEvent', 'DOMStringMap', 'ErrorEvent',
	'HashChangeEvent', 'History', 'ImageData', 'Location', 'MessageChannel',
	'MessageEvent', 'MessagePort', 'Navigator',
	'PageTransitionEvent', 'Plugin', 'PluginArray', 'PopStateEvent', 'PromiseRejectionEvent',
	'RadioNodeList', 'ValidityState', 'Window',
	'CanvasPattern', 'CanvasGradient', 'CanvasRenderingContext2D', 'CanvasImageSource', 'ImageBitmap'
];
...
var extracts = ['HTMLDocument', 'HTMLElement', 'HTMLBodyElement', 'HTMLAnchorElement',
	...
	'ErrorEvent', 'History', 'ImageData', 'Navigator',
