...
str.forEach(e => desc[e] = 'String method');
var mix = ['concat', 'includes', 'indexOf', 'slice', 'split'];
mix.forEach(e => desc[e] = 'Array/String method');
...
math.forEach(e => desc[e] = 'Math method');
...
date.forEach(e => desc[e] = 'Date method');
globalFunctions = globalFunctions.concat(arr, str, mix, math, date);
